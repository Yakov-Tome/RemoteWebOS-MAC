...
- **מצב קומפקטי** בגודל ווידג׳ט: הכפתור שליד נורית המצב (או *Remote → Compact mode*, ⌘⇧C) מכווץ את החלון
  ל-300×256, מצמיד אותו מעל שאר החלונות ומשאיר רק את הנדרש — VOL, CH, גלגל הניווט ו-OK, ובשורה התחתונה
  הפעלה, השתקה, Play-Pause, חזרה ובית. הבחירה נשמרת, והחזרה לשלט המלא מחזירה את החלון למקום ולגודל הקודמים.
